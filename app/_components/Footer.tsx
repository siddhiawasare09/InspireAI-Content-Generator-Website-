      ...
      <div>
        <div className="flex justify-center text-white sm:justify-start">
         <div className="flex items-center space-x-2">
           ...
           <a href="#" className="logo text-white font-bold text-xl">
             Inspire<span className="text-white">AI</span>
           </a>
         </div>
        </div>
        ...
        InspireAI simplifies content creation with advanced AI, delivering high-quality, multilingual, and customizable content in minutes. Trusted by thousands, it’s your go-to solution for boosting productivity and creativity.
        </p>
        ...
        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          ...
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="text-white hover:text-gray-200/75"
            >
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div className="text-center sm:text-left">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              <a className="text-white transition hover:text-gray-200/75" href="#">
                Company History
              </a>
            </li>

            <li>
              <a className="text-white hover:text-gray-200/75" href="#">
                Meet the Team
              </a>
            </li>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="flex-1 text-white">awasaresiddhi09@gmail.com</span>
              </a>
            </li>
